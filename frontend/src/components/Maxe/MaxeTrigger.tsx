...
.maxe-wrapper{--maxe-drift-distance:-88px;position:fixed;right:8px;bottom:8px;z-index:340;width:88px;height:150px;pointer-events:none;color:var(--em-ink,#090a0a)}
.maxe-wrapper.is-strolling{animation:maxe-drift 2.3s cubic-bezier(.77,0,.175,1) both}
.maxe-trigger{position:absolute;left:0;right:0;bottom:0;width:88px;height:32px;padding:0;border:0;background:transparent;color:inherit;pointer-events:auto;cursor:pointer;transition:height 260ms cubic-bezier(.23,1,.32,1),opacity 150ms ease-out}
.maxe-trigger:active{height:30px}
...
.maxe-figure{position:absolute;left:-16px;bottom:-115px;width:120px;height:162px;transition:bottom 260ms cubic-bezier(.23,1,.32,1);animation:maxe-idle-bob 3.4s var(--ease,cubic-bezier(.16,.84,.44,1)) infinite;will-change:transform,bottom}
.maxe-wrapper.is-marching .maxe-trigger{height:150px}
.maxe-wrapper.is-marching .maxe-trigger .maxe-figure{bottom:0px;animation:maxe-idle-bob 1.15s var(--ease,cubic-bezier(.16,.84,.44,1)) 2}
...
.maxe-trigger:focus-visible{outline:2px solid var(--em-ink,#090a0a);outline-offset:4px;height:150px}
.maxe-trigger:focus-visible .maxe-figure,.maxe-wrapper.is-nudging .maxe-trigger .maxe-figure{bottom:0px}
