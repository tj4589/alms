...
@keyframes maxe-idle-bob{0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)}}
...
.maxe-trigger-label{position:absolute;left:16px;right:16px;bottom:13px;display:flex;align-items:center;justify-content:center;min-height:32px;border-radius:17px;background:#34452e;color:#fffdf5;font:600 12px/1 'Outfit Variable',sans-serif;opacity:0;transform:translateY(6px);transition:opacity 150ms ease,transform 180ms cubic-bezier(.23,1,.32,1)}
.maxe-trigger:focus-visible{outline:2px solid var(--em-ink,#090a0a);outline-offset:4px;transform:scale(1) translate(0,0)}
...
.maxe-wrapper.is-nudging .maxe-trigger{transform:scale(1) translate(0,0)}
